...
public class RelationInfo implements Serializable {
    ...
    public RelationInfo(String callRelationSourcePath,  Granularity granularity, boolean isExternalPackageEnable) {
        ...
        if (file.isFile()) {
            ...
            ProjectCallRelationsStaticAnalyser analyser = new ProjectCallRelationsStaticAnalyser(callRelationSourcePath);
...
//                    System.out.println(relationIdFormat + " class call relation is duplicated.");
    ...
    public RelationInfo(Boolean concernedModifiedArtifact, String oldVersionCallRelationSource, String newVersionCallRelationSource, CorpusExtractor oldCorpus, CorpusExtractor newCorpus, String changedArtifactsPath, Granularity granularity) {
        ...
        if (oldFile.isFile() && newFile.isFile()) {
            ...
            ProjectCallRelationsStaticAnalyser analyserNew = new ProjectCallRelationsStaticAnalyser(newVersionCallRelationSource);
