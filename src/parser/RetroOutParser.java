...
public class RetroOutParser {
    ...
    public static SimilarityMatrix createSimilarityIR(String path, String version, int reqCount) {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                while (i.hasNext()) {
                    Element itemEle = (Element) i.next();
                    String uc = (itemEle.attribute("id")).getValue();
                    String text = ((DefaultText) ((DefaultElement) itemEle.content().get(0)).content().get(0)).getText();
                    double score = Double.parseDouble(text);
                    result.addLink(className, uc, score);
                }
            }
    ...
    public static void main(String[] args) {
        ...
        SimilarityMatrix sm = RetroOutParser.createSimilarityIR(retro_out_path, "change2", 39);
