...
public class ITrust_JSEP_Retro_AuthorKeyWords_Changes {
    public static void main(String[] args) {
        ...
        String retro_out_path_8 = "data/iTrust/retro/author_keywords/ch8.txt";
        String retro_out_path_9 = "data/iTrust/retro/author_keywords/ch9.txt";
        ...
        jsep_retro_myversion(ITrustSetting.iTrust_Change8_GroupedByJSEP,
                ITrustSetting.iTrust_CleanedRequirement, ITrustSetting.iTrustOracleChange8, retro_out_path_8, "Change8");

        jsep_retro_myversion(ITrustSetting.iTrust_Change9_GroupedByJSEP,
